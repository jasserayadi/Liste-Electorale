...
pkgdatadir = $(datadir)/le
pkgincludedir = $(includedir)/le
pkglibdir = $(libdir)/le
pkglibexecdir = $(libexecdir)/le
...
am_le_OBJECTS = main.$(OBJEXT) support.$(OBJEXT) interface.$(OBJEXT) \
	callbacks.$(OBJEXT) listeelectorale.$(OBJEXT)
le_OBJECTS = $(am_le_OBJECTS)
am__DEPENDENCIES_1 =
le_DEPENDENCIES = $(am__DEPENDENCIES_1)
AM_V_P = $(am__v_P_$(V))
...
ACLOCAL = ${SHELL} /home/mortadha/Downloads/ListeElectorale/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /home/mortadha/Downloads/ListeElectorale/missing autoconf
AUTOHEADER = ${SHELL} /home/mortadha/Downloads/ListeElectorale/missing autoheader
AUTOMAKE = ${SHELL} /home/mortadha/Downloads/ListeElectorale/missing automake-1.15
AWK = mawk
CATALOGS = 
CATOBJEXT = .gmo
CC = gcc
...
LTLIBOBJS = 
MAINT = 
MAKEINFO = ${SHELL} /home/mortadha/Downloads/ListeElectorale/missing makeinfo
MKDIR_P = /bin/mkdir -p
...
abs_builddir = /home/mortadha/Downloads/ListeElectorale/src
abs_srcdir = /home/mortadha/Downloads/ListeElectorale/src
abs_top_builddir = /home/mortadha/Downloads/ListeElectorale
abs_top_srcdir = /home/mortadha/Downloads/ListeElectorale
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/mortadha/Downloads/ListeElectorale/install-sh
...
le_LDADD = -lgtk-x11-2.0 -lgdk-x11-2.0 -lpangocairo-1.0 -latk-1.0 -lcairo -lgdk_pixbuf-2.0 -lgio-2.0 -lpangoft2-1.0 -lpango-1.0 -lgobject-2.0 -lglib-2.0 -lfontconfig -lfreetype $(INTLLIBS)
all: all-am
...
le$(EXEEXT): $(le_OBJECTS) $(le_DEPENDENCIES) $(EXTRA_le_DEPENDENCIES) 
	@rm -f le$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(le_OBJECTS) $(le_LDADD) $(LIBS)
...
include ./$(DEPDIR)/listeelectorale.Po
